...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            <flux:navbar.item icon="layout-grid" :href="route('listings.index')"
                :current="request()->routeIs('listings.index')" wire:navigate>
                {{ __('Listings') }}
            </flux:navbar.item>
        </flux:navbar>
        <flux:spacer />
    ...
    <flux:sidebar collapsible="mobile" sticky
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')">
                ...
                <div
                    class="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800/70 dark:text-zinc-300">
                    {{ __('Listings') }}
                </div>
            </flux:sidebar.group>

            <flux:sidebar.group :heading="__('Company')">
                <div
                    class="rounded-xl border border-zinc-200 bg-white px-3 py-3 dark:border-zinc-700 dark:bg-zinc-800/70">
